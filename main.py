...
st.markdown('Фридрих Вильгельм Хуго Бусмайер (Буссмейер, нем. Friedrich Wilhelm Hugo Bußmeyer; 26 февраля 1842, Брауншвейг ' \
           ...
           'монархии в 1889 году.[5] \n Twitter, 200 долларов, 150 р.', unsafe_allow_html=true)
if file is not None:
